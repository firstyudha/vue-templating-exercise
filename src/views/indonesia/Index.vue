                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="about-content" >
                            <h2>Indonesia</h2>
                            <h3>Data Source : https://indonesia-covid-19.mathdro.id/api</h3>
                            <div class="row mt-5">
                                <div class="col" v-if="covid19">
                                    <i class="ion-android-checkmark-circle"></i> Confirmed 
                                    <h3 class="ml-4 mt-2">{{new Intl.NumberFormat().format(covid19.jumlahKasus)}}</h3>
                                </div>
                                ...
                                <div class="col" v-if="covid19">
                                    ...
                                    <h3 class="ml-4 mt-2">{{new Intl.NumberFormat().format(covid19.sembuh)}}</h3>
                                </div>
                                <div class="col" v-else>
                                    <ContentLoader/>
                                </div>
                                <div class="col" v-if="covid19">
                                    ...
                                    <h3 class="ml-4 mt-2">{{new Intl.NumberFormat().format(covid19.meninggal)}}</h3>
                                </div>
                                <div class="col" v-else>
                                    <ContentLoader/>
                                </div>
